class ContainersCommon < Formula
  ...
  url "https://github.com/containers/common.git",
    tag:      "v0.41.0",
    revision: "96a047f6e2976fca01d32799f8f848ca283618ab"
  license "Apache-2.0"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, x86_64_linux: "1bf98c295cc935e19c4c919f2c2121a85132e57178619630b2bef3589a4f839d"
  end
